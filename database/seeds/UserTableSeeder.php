...
class UserTableSeeder extends Seeder
{
    ...
    private function randomSurname(){
        $array = ['Rosa', 'Scarparo', 'Capozzi', 'Casalini', 'Leclerc', 'Reeves', 'Gallus', 'Rozzi', 'Logallo', 'DeUghi', 'Corradi', 'DeLuca', 'Mosca', 'Sardo', 'Skywalker', 'Griffin', 'DiCesare', 'Dallavalle', 'Jacobs', 'Tamberi', 'Turk', 'Dorian', 'Cox', 'Reid', 'Peralta', 'Santiago', 'Diaz', 'House', 'Mosby', 'Picard', 'Stinson', 'Rossi', 'Sanchez', 'Montecchi', 'Capuleti', 'Montecristo', 'Villanueva', 'DiMonza', 'Mondella', 'Tramaglino'];
        shuffle($array); //mischia
        return $array[0];
    }
